...
namespace Testing {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string API) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string API {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'API\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsAPINull() {
                return this.IsNull(this.tableTable.APIColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetAPINull() {
                this[this.tableTable.APIColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Testing.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_API = 1 AND " +
                "[API] IS NULL) OR ([API] = @Original_API)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_API", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "API", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [API]) VALUES (@Id, @API);\r\nSELECT Id, API FROM " +
                "[Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [API] = @API WHERE (([Id] = @Original_Id) AN" +
                "D ((@IsNull_API = 1 AND [API] IS NULL) OR ([API] = @Original_API)));\r\nSELECT Id," +
                " API FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_API", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "API", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, API FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_API) {
            ...
            if ((Original_API == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_API));
            }
        ...
        public virtual int Insert(int Id, string API) {
        ...
        public virtual int Update(int Id, string API, int Original_Id, string Original_API) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string API, int Original_Id, string Original_API) {
            return this.Update(Original_Id, API, Original_Id, Original_API);
        }
    }
